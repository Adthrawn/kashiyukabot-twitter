...
class ImageTweet(object):
  ...
  def upload_init(self):
    ...
    '''
    print('INIT')
    self.mime_type = magic.from_file(self.image_filename, mime=True)
    request_data = {
      'command': 'INIT',
  ...
  def image_main(filename, message):
    imageTweet = ImageTweet(filename, message)
    imageTweet.upload_init()
    imageTweet.upload_append()
    imageTweet.upload_finalize()
    imageTweet.tweet(message)

if __name__ == '__main__':
  imageTweet = ImageTweet(VIDEO_FILENAME)
  imageTweet.upload_init()
  imageTweet.upload_append()
  imageTweet.upload_finalize()
  imageTweet.tweet(MESSAGE)
